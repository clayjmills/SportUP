...
class SportsListArray {
    ...
    static var sportsNames = ["Choose Sport", "⚾️Baseball", "🏀Basketball", "🚩Capture the flag", "🚴‍♀️Cycling", "🔘Disc golf", "🏈Football", "🎮Gaming", "⛳️Golf", "⛰Hiking", "🏒Hockey", "🔴Kickball", "🥅Lacrosse", "🏍Motorsports", "🚵Mountain biking", "🏓Ping pong", "🏉Rugby", "🏃Running", "Skate park", "⛷Skiing", "⚽️Soccer", "🏊Swimming", "🎾Tennis", "🏐Volleyball"]
}
